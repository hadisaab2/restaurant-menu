    ...
    <Container>
      ...
      <SearchWapper>
        <SearchContainer>
          ...
          <Search id="theme6-search-input" type="text" activeLanguage={activeLanguage} dir={activeLanguage == "en" ? "ltr" : "rtl"} placeholder={activeLanguage == "en" ? "Search Category" : "قائمة البحث"} onChange={handlesearch} value={searchText} />
        </SearchContainer>
        <ShareIcon onClick={() => {
