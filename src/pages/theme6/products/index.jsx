...
import { Container, ProductWrapper, CategoryTitleBar, CategoryTitleText, CategorySubtitle } from "./styles";
        ...
        <>
          {(() => {
            ...
            const catName = activeCat
              ? (activeLanguage === "ar" ? activeCat.ar_category : activeCat.en_category)
              : null;
            return catName ? (
              <CategoryTitleBar activeLanguage={activeLanguage}>
                <CategoryTitleText>{catName}</CategoryTitleText>
                <CategorySubtitle>
                  {activeLanguage === "ar" ? "اضغط على أي صنف للتخصيص" : "Tap any item to customize"}
                </CategorySubtitle>
              </CategoryTitleBar>
            ) : null;
          })()}
