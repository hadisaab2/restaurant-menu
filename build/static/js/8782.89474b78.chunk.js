...
`,Hp=n.Ay.div`
  ...
  z-index: 10000;
  pointer-events: none;
  animation: ${Yp} 0.6s cubic-bezier(0.4, 0, 0.2, 1) forwards;
  display: flex;
  align-items: center;
  justify-content: center;
  color: white;
