...
`,ne=n.Ay.button`
  ...
  border-radius: 12px;
  cursor: pointer;
  background: ${e=>e.$active?e.theme.mainColor||"#2563eb":"transparent"};
  color: ${e=>e.$active?e.theme.categoryActiveText||e.theme.popupbuttonText||"#fff":e.theme.categoryUnactiveText||e.theme.BoxTextColor||e.theme.textColor||"#334155"};
