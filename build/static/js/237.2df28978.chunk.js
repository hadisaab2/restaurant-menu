...
`,n.Ay.div`
  ...
  transition: all 0.2s ease;
  position: relative;
`;var s=i(71481),c=i(91965),u=(i(17123),i(56723));function g(e){let{activeView:t,showPopup:i=null,onHomeClick:n,hideHome:g=!1,onCategoriesClick:p,onCartClick:x,onContactClick:v,onFeedbackClick:h,onBranchesClick:f,restaurantName:m,branches:b,isProductDetailsOpen:y=!1}=e;(0,c.wA)();const k=(0,c.d4)((e=>{var t,i;return(null===(t=e.restaurant)||void 0===t||null===(i=t[m])||void 0===i?void 0:i.activeLanguage)||"en"})),j=(0,c.d4)((e=>{var t;return null===(t=e.restaurant)||void 0===t?void 0:t[m]})),$=(0,c.d4)((e=>{var t;return(null===(t=e.cart)||void 0===t?void 0:t[m])||[]})).reduce(((e,t)=>e+t.quantity),0),C=(()=>{try{const e=(null===j||void 0===j?void 0:j.features)||"{}";return"string"===typeof e?JSON.parse(e):e}catch{return{}}})(),w=[{id:"home",icon:s.rQ8,label:"en"===k?"Home":"\u0627\u0644\u0631\u0626\u064a\u0633\u064a\u0629",onClick:n,active:!i&&"home"===t},{id:"categories",icon:s.QJV,label:"en"===k?"Categories":"\u0627\u0644\u0641\u0626\u0627\u062a",onClick:p,active:!i&&("categories"===t||"products"===t)},{id:"cart",icon:s.AsH,label:"en"===k?"Cart":"\u0627\u0644\u0633\u0644\u0629",onClick:x,active:"cart"===i,badge:$>0?$:null},{id:"branches",icon:s.vq8,label:"en"===k?"Branches":"\u0627\u0644\u0641\u0631\u0648\u0639",onClick:f,active:"location"===i},{id:"feedback",icon:s.g5D,label:"en"===k?"Feedback":"\u0627\u0644\u062a\u0639\u0644\u064a\u0642\u0627\u062a",onClick:h,active:"feedback"===i}].filter((e=>(!g||"home"!==e.id)&&("branches"===e.id?b&&b.length>0:"feedback"!==e.id||!0===C.feedback)));null===j||void 0===j||j.languages;return(0,u.jsx)(a,{"data-tab-bar":!0,$isProductDetailsOpen:y,children:w.map((e=>(0,u.jsxs)(r,{"data-tab":e.id,onClick:e.onClick,$active:e.active,activeLanguage:k,children:[(0,u.jsxs)(o,{id:"cart"===e.id?"cart-tab-icon":void 0,$isLanguage:!1,$activeLanguage:k,children:[(0,u.jsx)(e.icon,{"data-icon":e.id}),e.badge&&(0,u.jsx)(d,{children:e.badge})]}),(0,u.jsx)(l,{activeLanguage:k,children:e.label})]},e.id)))})}},34500:(e,t,i)=>{i.d(t,{A:()=>K});var n=i(82483),a=i(41190);const r=a.Ay.nav`
  position: sticky;
  top: 0;
  left: 0;
  right: 0;
...
//# sourceMappingURL=237.2df28978.chunk.js.map