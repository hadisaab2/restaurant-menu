...
`,ja=e=>{let{onInstall:o,onDismiss:t,restaurantName:i,showInstallPopup:n}=e;return(0,E.jsxs)(fa,{showInstallPopup:n,children:[(0,E.jsxs)(va,{children:["Access ",(0,E.jsx)("b",{children:i})," anytime with one tap ",(0,E.jsx)("b",{children:"Install The App!"})]}),(0,E.jsxs)(ya,{children:[(0,E.jsx)(ba,{onClick:o,children:"Install"}),(0,E.jsx)(wa,{onClick:t,children:"Dismiss"})]})]})};var Ca=t(42978),$a=t(34500);function Aa(){var e,o,t;const[n,r]=(0,se.ok)(),a=n.get("productId"),c=n.get("categoryId"),{restaurantName:p}=(0,y.g)(),u=window.location.hostname.split(".")[0],h="menugic"!==u&&"localhost"!==u&&"www"!==u?u:p,x=(0,v.d4)((e=>{var o;return null===(o=e.restaurant)||void 0===o?void 0:o[h]})),[g,m]=((0,v.d4)((e=>{var o,t;return(null===(o=e.restaurant)||void 0===o||null===(t=o[h])||void 0===t?void 0:t.activeLanguage)||"en"})),(0,i.useState)(null)),[f,b]=(0,i.useState)(""),[w,j]=(0,i.useState)(null),[C,$]=(0,i.useState)(null),[A,k]=(0,i.useState)(!0),z=2===Number(null===x||void 0===x?void 0:x.template_id)&&(!0===(null===x||void 0===x?void 0:x.show_all_items_category)||1===(null===x||void 0===x?void 0:x.show_all_items_category)||"1"===(null===x||void 0===x?void 0:x.show_all_items_category)),S={id:"all-items",en_category:"All Items",ar_category:"\u0643\u0644 \u0627\u0644\u0623\u0635\u0646\u0627\u0641",isAllItems:!0,priority:999999,image_url:(null===x||void 0===x?void 0:x.logoURL)||(null===x||void 0===x?void 0:x.cover_url)||null},_=[...(null===x||void 0===x?void 0:x.categories)||[]].sort(((e,o)=>(o.priority||0)-(e.priority||0)||(e.id||0)-(o.id||0))),T=z?[S,..._]:_,[L,I]=(0,i.useState)(c?T.findIndex((e=>e.id==c)):0),[P,N]=((0,v.d4)((e=>(e.cart[h]||[]).reduce(((e,o)=>e+o.quantity),0))),(0,i.useState)(c||(null===T||void 0===T||null===(e=T[0])||void 0===e?void 0:e.id))),F=(0,i.useCallback)((e=>{N(e);const o=new URLSearchParams(n);"all-items"===e?o.delete("categoryId"):o.set("categoryId",e),r(o)}),[n,r]),D=e=>{document.body.style.overflow=null==e?"auto":"hidden",m(e)};(0,i.useEffect)((()=>{if(null!==x&&void 0!==x&&x.id){var e,o;const t=(null===x||void 0===x||null===(e=x.branches)||void 0===e||null===(o=e[0])||void 0===o?void 0:o.id)||null;(0,Ye.trackVisit)(x.id,t),(0,Ye.trackPageView)(x.id,t)}}),[null===x||void 0===x?void 0:x.id]),(0,i.useEffect)((()=>{console.log("\ud83d\udd0d PWA Debug Info:"),console.log("- Protocol:",window.location.protocol),console.log("- Host:",window.location.hostname),console.log("- Navigator:",navigator.userAgent);const e=e=>{e.preventDefault(),console.log("\u2705 Install prompt event captured!"),$(e),k(!0)};return window.addEventListener("beforeinstallprompt",e),window.addEventListener("appinstalled",(e=>{console.log("\ud83c\udf89 Application installed successfully!")})),()=>{window.removeEventListener("beforeinstallprompt",e)}}),[]);let B={};try{B=JSON.parse((null===x||void 0===x?void 0:x.features)||"{}")}catch(Qe){B={}}const R=(null===x||void 0===x?void 0:x.sliderImages)||[],U=(!0===(null===x||void 0===x?void 0:x.show_slider_image)||1===(null===x||void 0===x?void 0:x.show_slider_image)||"1"===(null===x||void 0===x?void 0:x.show_slider_image))&&R.length>0;return(0,E.jsxs)(l,{id:"wrapper",children:[(0,E.jsx)($a.A,{onProductsClick:()=>window.scrollTo({top:0,behavior:"smooth"}),onBranchesClick:()=>{window.history.pushState({},""),D("location")},onContactFormClick:()=>{window.history.pushState({},""),D("contactForm")},onFeedbackClick:()=>{window.history.pushState({},""),D("feedback")},onAboutClick:()=>{window.history.pushState({},""),D("about")},onOrderClick:()=>{var e;null!==(e=B)&&void 0!==e&&e.cart&&(window.history.pushState({},""),D("cart"))},onHomeClick:void 0,onCategoryClick:e=>{F(e);const o=T.findIndex((o=>o.id===e));o>=0&&I(o)},onContactClick:()=>{window.history.pushState({},""),D("contactForm")},categories:T,activeCategory:P,setshowSidebar:j,showSidebar:w,popupHandler:D,isProductDetailsOpen:!!a}),(0,E.jsxs)(s,{onClick:()=>{null!=g&&D(null)},children:[(0,E.jsx)(d,{showPopup:g}),(0,E.jsx)(le,{categories:T,activeCategory:P,setactiveCategory:F,setSearchText:b,searchText:f,setshowSidebar:j,showSidebar:w,carouselPosition:L,setcarouselPosition:I,popupHandler:D,showMenuSlider:U,sliderImages:R,hideHeaderTop:!0}),(0,E.jsx)(Ht,{menu:x.categories,activeCategory:P,showPopup:g,searchText:f,setactiveCategory:F,setcarouselPosition:I,carouselPosition:L,categories:T})]}),(0,E.jsx)(Ii,{restaurant:x,showPopup:g,popupHandler:D}),(null===(o=B)||void 0===o?void 0:o.cart)&&(0,E.jsx)(Tr,{restaurant:x,showPopup:g,popupHandler:D}),(0,E.jsx)(ua,{showPopup:g,popupHandler:D,activeCategory:P}),(0,E.jsx)(ha.A,{restaurant:x,showPopup:g,popupHandler:D}),(0,E.jsx)(xa.A,{restaurant:x,showPopup:g,popupHandler:D}),(0,E.jsx)(ga.A,{restaurant:x,showPopup:g,popupHandler:D}),(0,E.jsx)(Hr,{categories:T,activeCategory:P,setactiveCategory:F,setshowSidebar:j,showSidebar:w,setcarouselPosition:I,onFeedbackClick:()=>{window.history.pushState({},""),D("feedback")},onContactClick:()=>{window.history.pushState({},""),D("contactForm")},onBranchesClick:()=>{window.history.pushState({},""),D("location")},onAboutClick:()=>{window.history.pushState({},""),D("about")},onShareClick:()=>{window.history.pushState({},""),D("share")},branches:null===x||void 0===x?void 0:x.branches}),a&&(0,E.jsx)(Vr.A,{productId:a,searchParams:n,setSearchParams:r}),(null===(t=B)||void 0===t?void 0:t.install_app)&&(0,E.jsx)(ja,{showInstallPopup:A,onInstall:async()=>{if(!C)return;C.prompt();"accepted"===(await C.userChoice).outcome?console.log("User accepted the install"):console.log("User dismissed the install"),$(null),k(!1)},restaurantName:h,onDismiss:()=>k(!1)}),(0,E.jsx)(Ca.A,{hideHome:!0,activeView:"products",showPopup:g,onCategoriesClick:()=>window.scrollTo({top:0,behavior:"smooth"}),onCartClick:()=>{var e;null!==(e=B)&&void 0!==e&&e.cart&&(window.history.pushState({},""),D("cart"))},onFeedbackClick:()=>{window.history.pushState({},""),D("feedback")},onBranchesClick:()=>{window.history.pushState({},""),D("location")},restaurantName:h,branches:null===x||void 0===x?void 0:x.branches})]})}},20965:(e,o,t)=>{t(42564).default}}]);
//# sourceMappingURL=60.58b8764c.chunk.js.map