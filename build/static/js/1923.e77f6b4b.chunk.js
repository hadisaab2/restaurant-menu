"use strict";(self.webpackChunkrestaurant_menu=self.webpackChunkrestaurant_menu||[]).push([[1923],{41923:(e,t,r)=>{r.r(t),r.d(t,{default:()=>V});var a=r(88094),i=r(16750),o=r(57720),n=r(23373),s=r(81432),d=r(30410),l=r(36168),c=r(40710),p=r(56285),x=r(47518),g=r(61997),f=r(5854),b=r(55313),u=r(57256),h=r(13953),m=r(88402),y=r(39430),S=r(55821),v=r(76646),w=r(15678);const j="https://api.menugic.com",k=()=>({Authorization:`Bearer ${(0,s.getCookie)("accessToken")}`}),z={pageBg:"#f8fafc",accent:"#5eabb1",accentGlow:"rgba(94,171,177,0.22)",cardBg:"#ffffff",cardBorder:"rgba(148,163,184,0.18)",textPrimary:"#0f172a",textSub:"#64748b",shadow:"0 4px 20px rgba(15,23,42,0.07)",radius:"14px"},$=i.Ay.div`
  width: 100%;
  min-height: 100vh;
  display: flex;
